...
bool MyServer::sendToFile(QTcpSocket *pSocket, const QString &filename,
                          const size_t &fict, const size_t &size_fict)
{
    ...
    //for (qint64 i=size_fict_;i<count;i++) appFile.read(count-size_fict_);
    //QByteArray q = appFile.readAll();
